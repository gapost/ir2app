var Anneal = {
    ...
    cycle : function (Ta,ta,tw) {
        ...
        setSampleTs(Anneal.baseTemperature);
    ...
    cycleArray : function (Ta,ta,tw) {
        ...
        for(var i=0; i<n; ++i)
        {
            Anneal.setPIDparameters(Ta[i]);
            Anneal.annealCycle(Ta[i],ta[i],tw[i]);
        }
    },
    ...
    makeProgram : function() {
        ...
        dT=2.5;
        for(T=35; T<=90; T+=dT) { obj.Ta.push(T); obj.ta.push(dT); obj.tw.push(5);   }
        dT=3;
        ...
        dT=10;
        for(T=310; T<=400; T+=dT) { obj.Ta.push(T); obj.ta.push(dT); obj.tw.push(15);  }
        dT=15;
        for(T=415; T<=520; T+=dT) { obj.Ta.push(T); obj.ta.push(dT); obj.tw.push(30);  }
        dT=20;
        for(T=540; T<=700; T+=dT) { obj.Ta.push(T); obj.ta.push(dT); obj.tw.push(40);  }
